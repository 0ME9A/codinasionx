export default function DevsInfo() {
  return (
    <div className="p-2 md:p-10 lg:p-16 justify-center flex flex-col md:flex-row gap-3 items-start md:gap-5 lg:container mx-auto bg-gradient-to-tr from-light via-very-light to-very-light dark:from-darkII dark:via-very-dark relative dark:to-very-dark bg-darkII rounded-2xl lg:rounded-[50px] my-20 mb-2">
      <div
        className={`w-[20%] md:max-w-[300px] !rounded-full aspect-square bg-gradient-to-l from-transparent to-white  dark:to-dark animate-pulse`}
      ></div>
      <div
      ...
      <div
        className={
          " md:self-start order-5 md:absolute md:top-5 md:left-5 w-32 h-10 rounded-full bg-gradient-to-l from-transparent to-white dark:to-dark animate-pulse"
        }
      ></div>
    </div>
  );
