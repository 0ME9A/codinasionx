...
export default function ShowoffRepo({ order, id }: showoffRepos) {
  return (
    ...
    >
      <div
        className={`col-span-12 md:col-span-5 xl:col-span-6 aspect-square w-full h-full rounded-[50px] relative z-10 bg-gradient-to-l from-transparent to-white dark:to-dark dark:shadow-darkShadow-lg shadow-lightShadow-lg animate-pulse ${
