...
export default function Search() {
    ...
    return search.window ? (
        <div className="w-full h-screen fixed top-0 left-0 z-[999] text-black dark:text-white bg-white/50 dark:bg-black/50 backdrop-blur-md p-2 space-y-2">
            ...
            <div className="grid content-start gap-2 p-2 rounded-2xl max-w-[700px] w-full h-[85vh] mx-auto bg-very-light my-auto dark:bg-very-dark shadow-lg shadow-gray-500/30">
