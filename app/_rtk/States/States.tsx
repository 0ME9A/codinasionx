...
export interface CounterState {
    ...
    good1stissue: { data: good1stIssueType[]; status: number; };
    issueLabel: { data: labelType[]; status: number };
...
const initialState: CounterState = {
    ...
    good1stissue: { data: [], status: 404 },
    developers: { data: [], status: 404 },
    issueLabel: { data: [], status: 404 },
...
export const counterSlice = createSlice({
    ...
    reducers: {
        ...
        good1stissue: (state, action) => {
            state.good1stissue = { data: action.payload.data, status: action.payload.status }
        },
        issueLabel: (state, action) => {
            state.issueLabel = { data: action.payload.data, status: action.payload.status }
        },
...
export const { theme, searchProperties, program, developers, repositories, programProperties, issueProperties, repositoriesProperties, good1stissue, commonPropertie } = counterSlice.actions
